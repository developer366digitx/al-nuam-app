...
const BulkOrder = () => {
    ...
    return (
        ...
        <SafeAreaView style={{ flex: 1 }}>
            ...
            <View style={[styles.totalPriceWrapper, { bottom: dynamicBottom }]}>
                <View style={{ flexDirection: "row", gap: 5, justifyContent: "space-between" }}>
                    ...
                    <Pressable
                        ...
                        style={{
                            ...
                            borderColor: "#B6974E",
                            width: "50%",
                            backgroundColor: "#fff", // Adding background color for button-like appearance
                            paddingVertical: rMS(1), // Adjust padding for button size
                    ...
                    <Pressable onPress={() => nextSubCategory()} style={{
                        borderWidth: 1,
                        borderRadius: 6,
                        borderColor: "#B6974E",
                        width: "50%",
                        ...
                        <Text style={{ fontFamily: "Inter-Regular", fontSize: rMS(12), color: "grey", padding: rMS(5), textAlign: "center" }}>Next</Text>
            ...
            </View>
            {
                ...
                (<View style={[styles.totalPriceWrapper, { bottom: 0 }]}>
